...
function handleGetIncident(msg) {
  var incidentID = 'Incident Number';
  ...
  if (hasID) {
    ...
    var incident = helpDeskService.getIncident(REMEDY_WS_USERNAME, REMEDY_WS_PASSWORD, msg.additionalTokens[incidentID]);
    if (incident == null) {
    ...
    addTokens['Summary'] = 'Incident Number request property is not set';
  }    
